...
export class LumaSplatsLoader {
     ...
     * }} source - either the uuid of the capture or the capture artifacts
    ...
    events: {
        ...
        /** @type {EventEmitter<LoaderTexturePayload<Uint8Array>>} */
        updateSkyboxTexture: EventEmitter<LoaderTexturePayload<Uint8Array>>;
    ...
    /** @type {Promise<Array<LoaderTexturePayload<Uint8Array>> | null>} */
    skyboxReady: Promise<Array<LoaderTexturePayload<Uint8Array>> | null>;
    sceneRadius(): number;
    /**
    ...
    downloadSkybox(artifacts: {
        skybox_meta: string;
    }): Promise<LoaderTexturePayload<Uint8Array>[]>;
    /**
     * @param {Uint8Array} data
     * @param {number} width
     * @param {number} count
